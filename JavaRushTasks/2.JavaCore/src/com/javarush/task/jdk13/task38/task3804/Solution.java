...
/*- создай аннотацию Entity; - добавь ей три параметра: String name без значения по умолчания,
int value по умолчанию 45, boolean required по умолчанию true; - добавь ей возможность помечать классы;
